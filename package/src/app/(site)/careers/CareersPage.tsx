  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-14 sm:py-20 px-3 sm:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <span className="inline-block text-xs font-semibold text-primary uppercase tracking-widest px-3 py-1 bg-primary/10 rounded-full mb-4">Why Join Us</span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 drop-shadow-lg tracking-tight mb-3">Why Work With Us?</h2>
            <p className="text-sm sm:text-lg text-gray-600 font-medium max-w-2xl mx-auto">Join a team that values growth, innovation, and your success</p>
          </div>
      ...
      <section className="py-14 sm:py-20 px-3 sm:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <span className="inline-block text-xs font-semibold text-primary uppercase tracking-widest px-3 py-1 bg-primary/10 rounded-full mb-4">Benefits</span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 drop-shadow-lg tracking-tight mb-3">Perks & Benefits</h2>
            <p className="text-sm sm:text-lg text-gray-600 font-medium max-w-2xl mx-auto">We take care of our team with competitive compensation and excellent benefits</p>
          </div>
      ...
      <section id="open-positions" className="py-14 sm:py-20 px-3 sm:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <span className="inline-block text-xs font-semibold text-primary uppercase tracking-widest px-3 py-1 bg-primary/10 rounded-full mb-4">Now Hiring</span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 drop-shadow-lg tracking-tight mb-3">Open Positions</h2>
            <p className="text-sm sm:text-lg text-gray-600 font-medium max-w-2xl mx-auto">Find your perfect role and start your journey with us</p>
          </div>
              ...
              <GlassCard key={job.id} className="p-5 sm:p-8">
                <div className="flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-8">
                  ...
                  <div className="flex-shrink-0 flex flex-col gap-2">
                    ...
                    >
                      View Details <Icon icon="ph:arrow-right-bold" width={16} />
                    </button>
                    <button
      ...
      <section className="py-14 sm:py-20 px-3 sm:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <span className="inline-block text-xs font-semibold text-primary uppercase tracking-widest px-3 py-1 bg-primary/10 rounded-full mb-4">Our Culture</span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 drop-shadow-lg tracking-tight mb-3">Life at Satyajan Energy Solutions</h2>
            <p className="text-sm sm:text-lg text-gray-600 font-medium max-w-2xl mx-auto">A glimpse into our vibrant work culture and team spirit</p>
          </div>
      ...
      <section className="py-14 sm:py-20 px-3 sm:px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 sm:mb-14">
            <span className="inline-block text-xs font-semibold text-primary uppercase tracking-widest px-3 py-1 bg-primary/10 rounded-full mb-4">What We Stand For</span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-gray-900 drop-shadow-lg tracking-tight mb-3">Our Work Culture & Values</h2>
            <p className="text-sm sm:text-lg text-gray-600 font-medium max-w-2xl mx-auto">The principles that guide us every day</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {values.map((v, i) => (
              <GlassCard key={i} className="p-5 sm:p-7 flex flex-col items-center text-center">
