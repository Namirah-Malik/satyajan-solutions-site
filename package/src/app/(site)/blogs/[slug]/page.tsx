...
// ✅ Fixed: added canonical + proper metadata
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  const url = `https://satyajan.com/blogs/${slug}`;

  return {
    title:       blog.metaTitle || blog.title,
    description: blog.metaDescription || blog.excerpt,
    keywords:    blog.metaKeywords,
    // ✅ Canonical — each blog points to its own URL
    alternates: {
      canonical: url,
    },
    openGraph: {
      ...
      images: blog.featuredImage
        ...
        : [{ url: 'https://satyajan.com/images/og-default.jpg', width: 1200, height: 630 }],
    },
    twitter: {
      card:        'summary_large_image',
      title:       blog.metaTitle || blog.title,
      description: blog.metaDescription || blog.excerpt,
      images:      blog.featuredImage ? [blog.featuredImage] : ['https://satyajan.com/images/og-default.jpg'],
    },
  };
}
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  const articleSchema = {
    ...
    headline:           blog.title,
    description:        blog.metaDescription || blog.excerpt,
    image:              blog.featuredImage || 'https://satyajan.com/images/og-default.jpg',
    ...
    publisher: {
      ...
      logo: {
        '@type': 'ImageObject',
        url:     'https://satyajan.com/images/header/satyajan-logo.png',
      },
    },
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id':   `https://satyajan.com/blogs/${slug}`,
    },
  };

  return (
    <>
      {/* ✅ Blog article schema for Google rich results */}
      <script
