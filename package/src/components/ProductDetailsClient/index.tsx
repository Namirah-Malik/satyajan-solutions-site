              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  {adding ? (
                    ...
                    <>
                      <Icon icon="solar:cart-large-4-bold" width={20} />
                      Add to Cart
                    </>
                  )}
                </button>
                    ...
                    <div className="grid grid-cols-3 divide-x divide-gray-200">
                      {product.data.slice(0, 3).map((item: any, i: number) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="flex flex-col items-center py-4 px-3 text-center bg-white"
                          >
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      {product.salient_features.map((f: string, i: number) => (
                        <div
                          key={i}
                          className="flex items-start gap-2 px-4 py-2.5 bg-primary/5 border border-primary/20 rounded-full"
                        >
                          <Icon
                        ...
                        <tbody>
                          {product.specifications.map(
                            (spec: any, i: number) => (
                              ...
                              >
                                <td className="px-4 py-3 font-medium text-gray-700 border-b border-gray-100 w-1/2">
                                  {spec.labal}
                                </td>
