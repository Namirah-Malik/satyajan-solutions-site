...
export const existingBlogs = [
  {
    ...
    featuredImage: 'https://cms.microtek.in/upload/files/How-to-choose-high-capacity-UPS--for-heavy-load-appliances-1776311208027.jpeg',
...
`,
...

  {
    ...
    featuredImage: '/images/blog/top-5-signs-battery-needs-replacement.png',
    author: 'Satyajan Energy Solutions',
...
`,
...

  {
    ...
    featuredImage: '/images/blog/solar-vs-inverter-which-is-better.png',
    author: 'Satyajan Energy Solutions',
...
`,
...

  {
    ...
    featuredImage: '/images/blog/tips-for-maintaining-power-backup.png',
    author: 'Satyajan Energy Solutions',
...

  {
    ...
    featuredImage: '/images/blog/solar-vs-traditional-grid-electricity.png',
    author: 'Arlene McCoy',
...

  {
    ...
    featuredImage: '/images/blog/online-ups-with-lithium-battery-backup-solution.png',
    author: 'John Doe',
    publishedDate: '2025-01-02',
    readTime: '7 min read',
  ...
  // Add these to existingBlogs array in blogdata.ts

  {
    id: 'smart-inverter-app-monitoring',
    slug: 'smart-inverter-app-monitoring',
    title: 'Top Rated Inverters with App Monitoring for Real-Time Battery Tracking',
    category: 'inverters',
    excerpt: 'App-enabled inverters with WiFi monitoring let you track battery status, backup time and get alerts — all from your smartphone.',
    featuredImage: 'https://cms.microtek.in/upload/files/Top-Rated-Inverters-with-App-Monitoring-for-Real-Time-Battery-Tracking-1775845489175.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-03-10',
    readTime: '5 min read',
    metaTitle: 'Smart Inverters with App Monitoring | Real-Time Battery Tracking',
    metaDescription: 'Discover how WiFi-enabled smart inverters let you monitor battery levels and backup status in real time from your phone.',
    metaKeywords: 'smart inverter, app monitoring, WiFi inverter, battery tracking',
  },
  {
    id: 'online-ups-server-rooms-guide',
    slug: 'online-ups-server-rooms-guide',
    title: 'Buy Best Online UPS for Server Rooms – Complete Guide',
    category: 'tips',
    excerpt: 'Server rooms need zero-transfer-time power. Learn what features to look for in an Online UPS and how to size it correctly.',
    featuredImage: 'https://cms.microtek.in/upload/files/Buy-best-ONLINE-UPS-for-server-rooms--1775784280764.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-03-08',
    readTime: '6 min read',
    metaTitle: 'Best Online UPS for Server Rooms | Complete Buying Guide',
    metaDescription: 'Complete guide to choosing an Online UPS for server rooms. Features, capacity selection and protection explained.',
    metaKeywords: 'online UPS, server room UPS, double conversion UPS',
  },
  {
    id: 'next-gen-jumbo-ups-heavy-loads',
    slug: 'next-gen-jumbo-ups-heavy-loads',
    title: 'New Next-Gen Jumbo UPS Built for Longer Backup & Higher Loads',
    category: 'tips',
    excerpt: 'Next-gen Jumbo UPS systems handle heavy appliances like ACs, refrigerators and water pumps with DSP technology and long backup.',
    featuredImage: 'https://cms.microtek.in/upload/files/New-Next-Gen-JUMBO-UPS-Built-for-Longer-Backup---Higher-Loads--1774770691916.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-03-05',
    readTime: '5 min read',
    metaTitle: 'Next-Gen Jumbo UPS for Heavy Load Appliances | Long Backup',
    metaDescription: 'Next-generation Jumbo UPS for running heavy appliances during power cuts with pure sine wave output.',
    metaKeywords: 'Jumbo UPS, heavy load UPS, high capacity UPS',
  },
  {
    id: 'xtra-power-vturbo-inverter',
    slug: 'xtra-power-vturbo-inverter',
    title: 'Newly Launched XTRA POWER VTurbo Inverter for Modern Homes',
    category: 'inverters',
    excerpt: 'The VTurbo Inverter combines microcontroller intelligence, pure sine wave output and multi-stage charging for modern Indian homes.',
    featuredImage: 'https://cms.microtek.in/upload/files/Newly-Launched-XTRA-POWER-VTurbo-Inverter-for-Modern-Homes--1775694033984.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-03-01',
    readTime: '5 min read',
    metaTitle: 'XTRA POWER VTurbo Inverter | Smart Inverter for Modern Homes',
    metaDescription: 'The new VTurbo inverter features INTELLI pure sine wave technology, variable charging and full safety protection.',
    metaKeywords: 'VTurbo inverter, smart inverter, pure sine wave inverter',
  },
  {
    id: 'budget-inverter-2bhk-homes',
    slug: 'budget-inverter-2bhk-homes',
    title: 'Budget Friendly Inverter Solutions for 2BHK Homes',
    category: 'inverters',
    excerpt: 'Find the right VA rating and series for your 2BHK home — from entry-level to high capacity pure sine wave inverters.',
    featuredImage: 'https://cms.microtek.in/upload/files/Budget-Friendly-Inverter-Solutions-for-2BHK-Homes--1775115703535.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-02-25',
    readTime: '5 min read',
    metaTitle: 'Best Budget Inverter for 2BHK Homes | Buyer Guide 2025',
    metaDescription: 'Guide to choosing the right inverter for a 2BHK home — VA rating, battery selection and series comparison.',
    metaKeywords: 'inverter for 2BHK, budget inverter, home inverter',
  },
  {
    id: 'high-capacity-ups-heavy-appliances',
    slug: 'high-capacity-ups-heavy-appliances',
    title: 'How to Choose a High-Capacity UPS for Heavy Load Appliances',
    category: 'tips',
    excerpt: 'A step-by-step guide to selecting the right Jumbo UPS for ACs, washing machines and other heavy appliances.',
    featuredImage: 'https://cms.microtek.in/upload/files/How-to-choose-high-capacity-UPS--for-heavy-load-appliances-1776311208027.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-02-20',
    readTime: '6 min read',
    metaTitle: 'High-Capacity UPS for Heavy Load Appliances | Selection Guide',
    metaDescription: 'How to size and select a Jumbo UPS for heavy appliances with pure sine wave output and smart protection.',
    metaKeywords: 'high capacity UPS, Jumbo UPS, heavy load UPS',
  },
  {
    id: 'india-muft-bijli-scheme-2026',
    slug: 'india-muft-bijli-scheme-2026',
    title: "Is Solar Still Free? Know About India's 'Muft Bijli' Scheme in 2026",
    category: 'solar',
    excerpt: "Everything you need to know about the PM Surya Ghar Muft Bijli Yojana — who qualifies, how subsidies work, and what's changed in 2026.",
    featuredImage: 'https://cms.microtek.in/upload/files/Is-Solar-Still-Free-Know-About-India---s--PM-Surya-Ghar-Muft-Bijli-Yojna-in-2026-1772993944905.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-01-15',
    readTime: '6 min read',
    metaTitle: "PM Surya Ghar Muft Bijli Yojana 2026 | Solar Subsidy Guide",
    metaDescription: 'Is solar still free in 2026? Complete guide to the PM Surya Ghar scheme, subsidies and net metering.',
    metaKeywords: 'Muft Bijli Yojana, solar subsidy 2026, PM Surya Ghar',
  },
  {
    id: 'best-hybrid-solar-indian-homes',
    slug: 'best-hybrid-solar-indian-homes',
    title: 'Best Hybrid Solar Solution for Indian Homes',
    category: 'solar',
    excerpt: 'Hybrid solar systems combine panels, batteries and the grid to give you power day and night — even during outages.',
    featuredImage: '/images/blog/hybrid-inverter-for-modern-solar.png',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-01-10',
    readTime: '6 min read',
    metaTitle: 'Best Hybrid Solar System for Indian Homes 2026',
    metaDescription: 'Guide to hybrid solar systems — how they work, types, sizing and why they are ideal for Indian homes.',
    metaKeywords: 'hybrid solar, solar battery backup, solar system India',
  },
  {
    id: 'best-solar-inverters-india-2026',
    slug: 'best-solar-inverters-india-2026',
    title: 'Best Solar Inverters in India 2026: Features & Comparison',
    category: 'solar',
    excerpt: 'Compare off-grid, on-grid and hybrid solar inverters. Learn what MPPT efficiency, pure sine wave and warranty terms matter most.',
    featuredImage: 'https://cms.microtek.in/upload/files/Blog-Banner-9--1--1774953308163.jpg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-01-05',
    readTime: '7 min read',
    metaTitle: 'Best Solar Inverters in India 2026 | Features & Comparison',
    metaDescription: 'Compare the best solar inverters available in India in 2026 by type, efficiency, MPPT and warranty.',
    metaKeywords: 'solar inverter India 2026, MPPT solar inverter, hybrid inverter',
  },
  {
    id: 'solar-battery-right-for-home-2026',
    slug: 'solar-battery-right-for-home-2026',
    title: 'Is a Solar Battery Right for Your Home in 2026?',
    category: 'solar',
    excerpt: 'A real-world analysis of solar battery costs, benefits, sizing and when adding storage genuinely pays off for Indian homes.',
    featuredImage: 'https://cms.microtek.in/upload/files/Is-a-Solar-Battery-Right-for-Your-Home-in-2026-A-Real-World-Analysis-1772274510461.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-12-20',
    readTime: '6 min read',
    metaTitle: 'Is a Solar Battery Worth It in 2026? | Real-World Analysis',
    metaDescription: 'Should you add a solar battery in 2026? Analysis of costs, backup benefits and when the investment makes sense.',
    metaKeywords: 'solar battery 2026, lithium solar battery, solar storage India',
  },
  {
    id: 'best-solar-inverter-brands-2026',
    slug: 'best-solar-inverter-brands-2026',
    title: "Best Solar Inverter Brands for Home Use in 2026",
    category: 'solar',
    excerpt: 'What makes the best solar inverter in 2026 — efficiency, MPPT, monitoring, warranty and service network compared.',
    featuredImage: 'https://cms.microtek.in/upload/files/Blog-Banner-13-1775103201430.jpg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-12-15',
    readTime: '7 min read',
    metaTitle: 'Best Solar Inverter Brands for Home Use in 2026 | India Review',
    metaDescription: 'Practical review of what makes a solar inverter the best choice for Indian homes in 2026.',
    metaKeywords: 'best solar inverter brand 2026, solar inverter review India',
  },
  {
    id: 'best-solar-power-solutions-india-subsidy-2026',
    slug: 'best-solar-power-solutions-india-subsidy-2026',
    title: 'Best Solar Power Solutions for Homes in India with Subsidy in 2026',
    category: 'solar',
    excerpt: 'How to choose the right solar system type, claim government subsidies and maximise long-term savings in 2026.',
    featuredImage: 'https://cms.microtek.in/upload/files/Blog-Banner-15-1774367635653.jpg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2025-12-10',
    readTime: '7 min read',
    metaTitle: 'Best Solar Power Solutions India 2026 | Subsidy & Savings Guide',
    metaDescription: 'Complete guide to solar power solutions in India 2026 — subsidies, system types and how to apply.',
    metaKeywords: 'solar power India 2026, solar subsidy, rooftop solar',
  },
  {
    id: 'new-lithium-bluetooth-battery',
    slug: 'new-lithium-bluetooth-battery-now-monitor-power-on-your-phone',
    title: 'New Lithium Bluetooth Battery: Now Monitor Power on Your Phone',
    category: 'batteries',
    excerpt: 'The new Bluetooth-based lithium battery lets you track battery level, health, and backup duration directly from your smartphone. Built with LiFePO4 technology for instant charging and long life.',
    featuredImage: 'https://cms.microtek.in/upload/files/New-Lithium-Bluetooth-Battery--Now-Monitor-Power-on-Your-Phone-1775368221624.jpg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-02-08',
    readTime: '5 min read',
    metaTitle: 'New Lithium Bluetooth Battery: Monitor Power on Your Phone | Microtek',
    metaDescription: 'Track your battery health, charge level and backup duration from your smartphone with the new Microtek Lithium Bluetooth Battery.',
    metaKeywords: 'lithium bluetooth battery, smart battery monitoring, LiFePO4 battery, inverter battery app',
  },
  {
    id: 'why-2026-best-year-switch-lithium-battery',
    slug: 'why-2026-is-the-best-year-to-switch-your-home-to-lithium-battery',
    title: 'Why 2026 is the Best Year to Switch Your Home to Lithium Battery?',
    category: 'batteries',
    excerpt: 'Small apartments and homes need power backup that fits limited space. Compact lithium-based UPS systems are efficient, lightweight, and perfect for modern homes. Here is why 2026 is the right time to switch.',
    featuredImage: 'https://cms.microtek.in/upload/files/Why-2026-is-the-Best-Year-to-Switch-to-Lithium-Battery--1775194023085.jpg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-01-23',
    readTime: '6 min read',
    metaTitle: 'Why 2026 is the Best Year to Switch to Lithium Battery | Microtek',
    metaDescription: 'Discover why 2026 is the ideal time to upgrade to lithium battery for your home inverter. Better pricing, longer life, and zero maintenance.',
    metaKeywords: 'lithium battery 2026, switch to lithium, LiFePO4 home battery, best inverter battery 2026',
  },
  {
    id: 'fast-charging-vs-long-life-battery',
    slug: 'fast-charging-vs-long-life-can-your-inverter-battery-actually-do-both',
    title: 'Fast Charging vs. Long Life: Can Your Inverter Battery Actually Do Both?',
    category: 'batteries',
    excerpt: 'Many believe fast charging and long battery life cannot coexist. But technology has advanced greatly. Discover how modern inverter batteries balance both needs for Indian homes.',
    featuredImage: 'https://cms.microtek.in/upload/files/Fast-Charging-vs-1772382277631.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-01-14',
    readTime: '5 min read',
    metaTitle: 'Fast Charging vs Long Life Inverter Battery | Can It Do Both?',
    metaDescription: 'Learn how modern inverter batteries combine fast charging and long life. Expert guide for Indian homeowners choosing the right battery.',
    metaKeywords: 'fast charging inverter battery, long life battery, inverter battery comparison, best battery India',
  },
  {
    id: 'online-ups-protect-server-rooms',
    slug: 'how-online-ups-systems-protect-server-rooms-from-power-failures',
    title: 'How Online UPS Systems Protect Server Rooms from Power Failures',
    category: 'tips',
    excerpt: 'Power outages can crash servers, corrupt files, and damage hardware. Online UPS systems with double-conversion technology provide zero-transfer-time protection for server rooms.',
    featuredImage: 'https://cms.microtek.in/upload/files/How-Online-UPS-protects-critical-Applications-like-Server-Rooms-from-Power-Failures-1772573885332.jpeg',
    author: 'Satyajan Energy Solutions',
    publishedDate: '2026-01-13',
    readTime: '6 min read',
    metaTitle: 'How Online UPS Protects Server Rooms from Power Failures | Guide',
