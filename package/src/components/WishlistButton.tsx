...
export default function WishlistButton({ item, size = 'md', className = '' }: WishlistButtonProps) {
  ...
  const sizeMap = { sm: { btn: 'w-7 h-7', icon: 14 }, md: { btn: 'w-9 h-9', icon: 18 }, lg: { btn: 'w-11 h-11', icon: 22 } };
    ...
    <button
      ...
      className={`
        ...
        ${wishlisted
          ...
          : 'bg-white/90 text-gray-400 hover:text-red-400 hover:bg-red-50 shadow-md backdrop-blur-sm'
        }
